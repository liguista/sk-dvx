...
/**
	 ...
	 * @see org.ski.dvx.hibernate.Country
...
public class CountryDAO extends BaseHibernateDAO  {
    ...
    public Country findById( java.lang.Integer id) {
        ...
        try {
            Country instance = (Country) getSession()
                    .get("org.ski.dvx.hibernate.Country", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(Country instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("org.ski.dvx.hibernate.Country")
    ...
    public Country merge(Country detachedInstance) {
        ...
        try {
            Country result = (Country) getSession()
