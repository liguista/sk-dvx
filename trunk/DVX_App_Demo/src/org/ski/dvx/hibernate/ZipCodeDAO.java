...
/**
 	* A data access object (DAO) providing persistence and search support for ZipCode entities.
 			* Transaction control of the save(), update() and delete() operations 
		can directly support Spring container-managed transactions or they can be augmented	to handle user-managed Spring transactions. 
		Each of these methods provides additional information for how to configure it for the desired type of transaction control. 	
	 * @see org.ski.dvx.hibernate.ZipCode
...
public class ZipCodeDAO extends BaseHibernateDAO  {
    ...
    public ZipCode findById( java.lang.Integer id) {
        ...
        try {
            ZipCode instance = (ZipCode) getSession()
                    .get("org.ski.dvx.hibernate.ZipCode", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(ZipCode instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("org.ski.dvx.hibernate.ZipCode")
    ...
    public ZipCode merge(ZipCode detachedInstance) {
        ...
        try {
            ZipCode result = (ZipCode) getSession()
