...
/**
 * AbstractState entity provides the base persistence definition of the State entity. @author MyEclipse Persistence Tools
 */
...
public abstract class AbstractState  implements java.io.Serializable {
    ...
    /** full constructor */
    public AbstractState(Country country, String stateName, String stateNameShort, Timestamp created, Timestamp modified, Set zipCodes, Set cities, Set userDetails) {
