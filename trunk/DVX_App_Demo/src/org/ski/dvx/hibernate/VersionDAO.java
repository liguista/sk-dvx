...
/**
 	* A data access object (DAO) providing persistence and search support for Version entities.
...
public class VersionDAO extends BaseHibernateDAO  {
    ...
    public Version findById( java.lang.Integer id) {
        ...
        try {
            Version instance = (Version) getSession()
                    .get("org.ski.dvx.hibernate.Version", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public Version merge(Version detachedInstance) {
        ...
        try {
            Version result = (Version) getSession()
