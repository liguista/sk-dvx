...
/**
 * AbstractReview entity provides the base persistence definition of the Review entity. @author MyEclipse Persistence Tools
 */
...
public abstract class AbstractReview  implements java.io.Serializable {
    ...
    /** full constructor */
    public AbstractReview(Movie movie, User user, Integer reviewLanguageFk, Integer reviewVersionFk, String reviewSummary, String reviewLong, Boolean reviewActive, Timestamp created, Timestamp modified) {
        this.movie = movie;
        this.user = user;
