...
/**
 * AbstractAudioTrackInfo entity provides the base persistence definition of the AudioTrackInfo entity. @author MyEclipse Persistence Tools
 */
...
public abstract class AbstractAudioTrackInfo  implements java.io.Serializable {
    ...
    /** full constructor */
    public AbstractAudioTrackInfo(String audioTrackDescription, Integer audioTrackGain, Integer audioTrackPan, Timestamp created, Timestamp modified) {
