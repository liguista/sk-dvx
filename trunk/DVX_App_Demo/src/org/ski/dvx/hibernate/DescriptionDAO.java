...
/**
 	* A data access object (DAO) providing persistence and search support for Description entities.
...
public class DescriptionDAO extends BaseHibernateDAO  {
    ...
    public Description findById( java.lang.Integer id) {
        ...
        try {
            Description instance = (Description) getSession()
                    .get("org.ski.dvx.hibernate.Description", id);
            return instance;
        } catch (RuntimeException re) {
	...
	public List findByDescriptionStartTimeInt(Object descriptionStartTimeInt
		...
		return findByProperty(DESCRIPTION_START_TIME_INT, descriptionStartTimeInt
		);
	}
	...
	public List findByDescriptionStartTimeText(Object descriptionStartTimeText
		...
		return findByProperty(DESCRIPTION_START_TIME_TEXT, descriptionStartTimeText
		);
	}
	...
	public List findByDescriptionDurationText(Object descriptionDurationText
		...
		return findByProperty(DESCRIPTION_DURATION_TEXT, descriptionDurationText
		);
	}
    ...
    public Description merge(Description detachedInstance) {
        ...
        try {
            Description result = (Description) getSession()
