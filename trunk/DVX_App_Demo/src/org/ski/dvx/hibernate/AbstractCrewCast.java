...
/**
 * AbstractCrewCast entity provides the base persistence definition of the CrewCast entity. @author MyEclipse Persistence Tools
 */
...
public abstract class AbstractCrewCast  implements java.io.Serializable {
    ...
    /** full constructor */
    public AbstractCrewCast(Author author, String crewCastFullName, String crewCastFirstName, String crewCastMiddleName, String crewCastLastName, Date crewCastBirthday, String crewCastDescription, String crewCastBiography, Timestamp created, Timestamp modified, Set movieCasts) {
        this.author = author;
