...
/**
 	* A data access object (DAO) providing persistence and search support for MovieGenre entities.
 			* Transaction control of the save(), update() and delete() operations 
		can directly support Spring container-managed transactions or they can be augmented	to handle user-managed Spring transactions. 
		Each of these methods provides additional information for how to configure it for the desired type of transaction control. 	
	 * @see org.ski.dvx.hibernate.MovieGenre
  * @author MyEclipse Persistence Tools 
 */

public class MovieGenreDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(MovieGenreDAO.class);
		//property constants
    ...
    public MovieGenre findById( java.lang.Integer id) {
        ...
        try {
            MovieGenre instance = (MovieGenre) getSession()
                    .get("org.ski.dvx.hibernate.MovieGenre", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(MovieGenre instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("org.ski.dvx.hibernate.MovieGenre")
	...
	public List findByMovieGenreDescriptionLong(Object movieGenreDescriptionLong
		...
		return findByProperty(MOVIE_GENRE_DESCRIPTION_LONG, movieGenreDescriptionLong
		);
	}
    ...
    public MovieGenre merge(MovieGenre detachedInstance) {
        ...
        try {
            MovieGenre result = (MovieGenre) getSession()
