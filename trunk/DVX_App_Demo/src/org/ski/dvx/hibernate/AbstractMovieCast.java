...
/**
 * AbstractMovieCast entity provides the base persistence definition of the MovieCast entity. @author MyEclipse Persistence Tools
 */
...
public abstract class AbstractMovieCast  implements java.io.Serializable {
    ...
    /** full constructor */
    public AbstractMovieCast(Movie movie, CrewCast crewCast, Integer movieCastRoleOrder, String movieCastRoleName, String movieCastRoleDescription, Timestamp created, Timestamp modified) {
        this.movie = movie;
