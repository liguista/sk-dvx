 ...
 * 
 * @see org.ski.dvx.server.hibernate.movie.Movie
...
public class MovieDAO extends BaseHibernateDAO {
	...
	public static final String MOVIE_RATED_FK = "movieRatedFk";
	...
	public static final String MOVIE_STATUS_FK = "movieStatusFk";
	...
	public static final String MOVIE_COUNTRY_OF_ORIGIN_FK = "movieCountryOfOriginFk";
	...
	public Movie findById(java.lang.Integer id) {
		...
		try {
			Movie instance = (Movie) getSession().get(
					"org.ski.dvx.server.hibernate.movie.Movie", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Movie instance) {
		...
		try {
			List results = getSession()
					.createCriteria("org.ski.dvx.server.hibernate.movie.Movie")
	...
	public List findByMovieRatedFk(Object movieRatedFk) {
		return findByProperty(MOVIE_RATED_FK, movieRatedFk);
	}
	...
	public List findByMovieStatusFk(Object movieStatusFk) {
		return findByProperty(MOVIE_STATUS_FK, movieStatusFk);
	}
	...
	public List findByMovieCountryOfOriginFk(Object movieCountryOfOriginFk) {
		return findByProperty(MOVIE_COUNTRY_OF_ORIGIN_FK,
				movieCountryOfOriginFk);
	}
