 ...
 * 
 * @see org.ski.dvx.server.hibernate.user_detail.UserDetail
...
public class UserDetailDAO extends BaseHibernateDAO {
	...
	// property constants
	public static final String USER_DETAIL_USER_FK = "userDetailUserFk";
	...
	public static final String USER_DETAIL_CITY_FK = "userDetailCityFk";
	public static final String USER_DETAIL_STATE_FK = "userDetailStateFk";
	public static final String USER_DETAIL_ZIP_CODE_FK = "userDetailZipCodeFk";
	public static final String USER_DETAIL_COUNTRY_FK = "userDetailCountryFk";
	...
	public static final String USER_DETAIL_SUBSCRIPTION_START = "userDetailSubscriptionStart";
	public static final String USER_DETAIL_SUBSCRIPTION_END_DATE = "userDetailSubscriptionEndDate";
	...
	public UserDetail findById(java.lang.Integer id) {
		...
		try {
			UserDetail instance = (UserDetail) getSession().get(
					"org.ski.dvx.server.hibernate.user_detail.UserDetail", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(UserDetail instance) {
		...
		try {
			List results = getSession()
					.createCriteria(
							"org.ski.dvx.server.hibernate.user_detail.UserDetail")
	...
	public List findByUserDetailUserFk(Object userDetailUserFk) {
		return findByProperty(USER_DETAIL_USER_FK, userDetailUserFk);
	}
	...
	public List findByUserDetailCityFk(Object userDetailCityFk) {
		return findByProperty(USER_DETAIL_CITY_FK, userDetailCityFk);
	}

	public List findByUserDetailStateFk(Object userDetailStateFk) {
		return findByProperty(USER_DETAIL_STATE_FK, userDetailStateFk);
	}

	public List findByUserDetailZipCodeFk(Object userDetailZipCodeFk) {
		return findByProperty(USER_DETAIL_ZIP_CODE_FK, userDetailZipCodeFk);
	}

	public List findByUserDetailCountryFk(Object userDetailCountryFk) {
		return findByProperty(USER_DETAIL_COUNTRY_FK, userDetailCountryFk);
	}

	public List findByUserDetailWorkPhoneNumber(Object userDetailWorkPhoneNumber) {
		return findByProperty(USER_DETAIL_WORK_PHONE_NUMBER,
				userDetailWorkPhoneNumber);
	}

	public List findByUserDetailHomePhoneNumber(Object userDetailHomePhoneNumber) {
		return findByProperty(USER_DETAIL_HOME_PHONE_NUMBER,
				userDetailHomePhoneNumber);
	}

	public List findByUserDetailCellPhoneNumber(Object userDetailCellPhoneNumber) {
		return findByProperty(USER_DETAIL_CELL_PHONE_NUMBER,
				userDetailCellPhoneNumber);
	}

	public List findByUserDetailSubscriptionStart(
			Object userDetailSubscriptionStart) {
		return findByProperty(USER_DETAIL_SUBSCRIPTION_START,
				userDetailSubscriptionStart);
	}

	public List findByUserDetailSubscriptionEndDate(
			Object userDetailSubscriptionEndDate) {
		return findByProperty(USER_DETAIL_SUBSCRIPTION_END_DATE,
				userDetailSubscriptionEndDate);
	}
	...
	public List findByUserDetailVisionAbility(Object userDetailVisionAbility) {
		return findByProperty(USER_DETAIL_VISION_ABILITY,
				userDetailVisionAbility);
	}
