 ...
 * 
 * @see org.ski.dvx.server.hibernate.audio_track_info.AudioTrackInfo
	...
	public AudioTrackInfo findById(java.lang.Integer id) {
		...
		try {
			AudioTrackInfo instance = (AudioTrackInfo) getSession()
					.get("org.ski.dvx.server.hibernate.audio_track_info.AudioTrackInfo",
							id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(AudioTrackInfo instance) {
		...
		try {
			List results = getSession()
					.createCriteria(
							"org.ski.dvx.server.hibernate.audio_track_info.AudioTrackInfo")
