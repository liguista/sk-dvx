 ...
 * 
 * @see org.ski.dvx.server.hibernate.description.Description
...
public class DescriptionDAO extends BaseHibernateDAO {
	...
	// property constants
	public static final String AUTHOR_FK = "authorFk";
	public static final String DESCRIPTION_LANGUAGE_FK = "descriptionLanguageFk";
	public static final String MOVIE_FK = "movieFk";
	public static final String DESCRIPTION_TITLE_ID = "descriptionTitleId";
	...
	public static final String DESCRIPTION_META_DATA = "descriptionMetaData";
	public static final String DESCRIPTION_META_XML = "descriptionMetaXml";
	public static final String DESCRIPTION_VERSION = "descriptionVersion";
	public static final String DESCRIPTION_PATH_FK = "descriptionPathFk";
	...
	public Description findById(java.lang.Integer id) {
		...
		try {
			Description instance = (Description) getSession().get(
					"org.ski.dvx.server.hibernate.description.Description", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Description instance) {
		...
		try {
			List results = getSession()
					.createCriteria(
							"org.ski.dvx.server.hibernate.description.Description")
	...
	public List findByAuthorFk(Object authorFk) {
		return findByProperty(AUTHOR_FK, authorFk);
	}

	public List findByDescriptionLanguageFk(Object descriptionLanguageFk) {
		return findByProperty(DESCRIPTION_LANGUAGE_FK, descriptionLanguageFk);
	}
	...
	public List findByDescriptionTitleId(Object descriptionTitleId) {
		return findByProperty(DESCRIPTION_TITLE_ID, descriptionTitleId);
	}
	...
	public List findByDescriptionMetaData(Object descriptionMetaData) {
		return findByProperty(DESCRIPTION_META_DATA, descriptionMetaData);
	}

	public List findByDescriptionMetaXml(Object descriptionMetaXml) {
		return findByProperty(DESCRIPTION_META_XML, descriptionMetaXml);
	}
	...
	public List findByDescriptionPathFk(Object descriptionPathFk) {
		return findByProperty(DESCRIPTION_PATH_FK, descriptionPathFk);
	}
