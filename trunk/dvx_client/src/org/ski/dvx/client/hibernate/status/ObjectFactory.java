 ...
 * element interface generated in the org.ski.dvx.client.hibernate.status
 * package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _FindAllResponse_QNAME = new QName(
			"http://status.hibernate.server.dvx.ski.org/", "findAllResponse");
	private final static QName _AttachDirty_QNAME = new QName(
			"http://status.hibernate.server.dvx.ski.org/", "attachDirty");
	private final static QName _FindByCreated_QNAME = new QName(
			"http://status.hibernate.server.dvx.ski.org/", "findByCreated");
	private final static QName _Delete_QNAME = new QName(
			"http://status.hibernate.server.dvx.ski.org/", "delete");
	private final static QName _FindById_QNAME = new QName(
			"http://status.hibernate.server.dvx.ski.org/", "findById");
	private final static QName _SaveResponse_QNAME = new QName(
			"http://status.hibernate.server.dvx.ski.org/", "saveResponse");
	...
	private final static QName _FindByExample_QNAME = new QName(
			"http://status.hibernate.server.dvx.ski.org/", "findByExample");
	private final static QName _DeleteResponse_QNAME = new QName(
			"http://status.hibernate.server.dvx.ski.org/", "deleteResponse");
	private final static QName _AttachClean_QNAME = new QName(
			"http://status.hibernate.server.dvx.ski.org/", "attachClean");
	private final static QName _FindByStatusDescription_QNAME = new QName(
			"http://status.hibernate.server.dvx.ski.org/",
			"findByStatusDescription");
	...
	private final static QName _FindByModified_QNAME = new QName(
			"http://status.hibernate.server.dvx.ski.org/", "findByModified");
	...
	private final static QName _Merge_QNAME = new QName(
			"http://status.hibernate.server.dvx.ski.org/", "merge");
	private final static QName _FindAll_QNAME = new QName(
			"http://status.hibernate.server.dvx.ski.org/", "findAll");
	...
	private final static QName _FindByStatusDescriptionResponse_QNAME = new QName(
			"http://status.hibernate.server.dvx.ski.org/",
			"findByStatusDescriptionResponse");
	private final static QName _AttachDirtyResponse_QNAME = new QName(
			"http://status.hibernate.server.dvx.ski.org/",
			"attachDirtyResponse");
	private final static QName _Save_QNAME = new QName(
			"http://status.hibernate.server.dvx.ski.org/", "save");
	private final static QName _FindByIdResponse_QNAME = new QName(
			"http://status.hibernate.server.dvx.ski.org/", "findByIdResponse");
	private final static QName _MergeResponse_QNAME = new QName(
			"http://status.hibernate.server.dvx.ski.org/", "mergeResponse");
	private final static QName _FindByProperty_QNAME = new QName(
			"http://status.hibernate.server.dvx.ski.org/", "findByProperty");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of
	 * schema derived classes for package: org.ski.dvx.client.hibernate.status
	 * 
	 */
	...
	/**
	 * Create an instance of {@link FindByStatusDescriptionResponse }
	 * 
	 */
	public FindByStatusDescriptionResponse createFindByStatusDescriptionResponse() {
		return new FindByStatusDescriptionResponse();
	}
	...
	/**
	 * Create an instance of {@link FindByStatusDescription }
	 * 
	 */
	public FindByStatusDescription createFindByStatusDescription() {
		return new FindByStatusDescription();
	}
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://status.hibernate.server.dvx.ski.org/", name = "findAllResponse")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://status.hibernate.server.dvx.ski.org/", name = "attachDirty")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://status.hibernate.server.dvx.ski.org/", name = "findByCreated")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://status.hibernate.server.dvx.ski.org/", name = "delete")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://status.hibernate.server.dvx.ski.org/", name = "findById")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://status.hibernate.server.dvx.ski.org/", name = "saveResponse")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://status.hibernate.server.dvx.ski.org/", name = "attachCleanResponse")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://status.hibernate.server.dvx.ski.org/", name = "findByExample")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://status.hibernate.server.dvx.ski.org/", name = "deleteResponse")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://status.hibernate.server.dvx.ski.org/", name = "attachClean")
	...
	/**
	 * Create an instance of {@link JAXBElement }{@code <}
	 * {@link FindByStatusDescription }{@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "http://status.hibernate.server.dvx.ski.org/", name = "findByStatusDescription")
	public JAXBElement<FindByStatusDescription> createFindByStatusDescription(
			FindByStatusDescription value) {
		return new JAXBElement<FindByStatusDescription>(
				_FindByStatusDescription_QNAME, FindByStatusDescription.class,
				null, value);
	}
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://status.hibernate.server.dvx.ski.org/", name = "findByPropertyResponse")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://status.hibernate.server.dvx.ski.org/", name = "findByModified")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://status.hibernate.server.dvx.ski.org/", name = "findByModifiedResponse")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://status.hibernate.server.dvx.ski.org/", name = "merge")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://status.hibernate.server.dvx.ski.org/", name = "findAll")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://status.hibernate.server.dvx.ski.org/", name = "findByCreatedResponse")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://status.hibernate.server.dvx.ski.org/", name = "findByExampleResponse")
	...
	/**
	 * Create an instance of {@link JAXBElement }{@code <}
	 * {@link FindByStatusDescriptionResponse }{@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "http://status.hibernate.server.dvx.ski.org/", name = "findByStatusDescriptionResponse")
	public JAXBElement<FindByStatusDescriptionResponse> createFindByStatusDescriptionResponse(
			FindByStatusDescriptionResponse value) {
		return new JAXBElement<FindByStatusDescriptionResponse>(
				_FindByStatusDescriptionResponse_QNAME,
				FindByStatusDescriptionResponse.class, null, value);
	}
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://status.hibernate.server.dvx.ski.org/", name = "attachDirtyResponse")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://status.hibernate.server.dvx.ski.org/", name = "save")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://status.hibernate.server.dvx.ski.org/", name = "findByIdResponse")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://status.hibernate.server.dvx.ski.org/", name = "mergeResponse")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://status.hibernate.server.dvx.ski.org/", name = "findByProperty")
