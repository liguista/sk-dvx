 ...
 * element interface generated in the org.ski.dvx.client.hibernate.path package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _AttachCleanResponse_QNAME = new QName(
			"http://path.hibernate.server.dvx.ski.org/", "attachCleanResponse");
	private final static QName _FindByExample_QNAME = new QName(
			"http://path.hibernate.server.dvx.ski.org/", "findByExample");
	private final static QName _DeleteResponse_QNAME = new QName(
			"http://path.hibernate.server.dvx.ski.org/", "deleteResponse");
	private final static QName _AttachDirty_QNAME = new QName(
			"http://path.hibernate.server.dvx.ski.org/", "attachDirty");
	private final static QName _FindByCreated_QNAME = new QName(
			"http://path.hibernate.server.dvx.ski.org/", "findByCreated");
	private final static QName _Merge_QNAME = new QName(
			"http://path.hibernate.server.dvx.ski.org/", "merge");
	private final static QName _FindByPathPrefix_QNAME = new QName(
			"http://path.hibernate.server.dvx.ski.org/", "findByPathPrefix");
	...
	private final static QName _Save_QNAME = new QName(
			"http://path.hibernate.server.dvx.ski.org/", "save");
	private final static QName _MergeResponse_QNAME = new QName(
			"http://path.hibernate.server.dvx.ski.org/", "mergeResponse");
	private final static QName _FindById_QNAME = new QName(
			"http://path.hibernate.server.dvx.ski.org/", "findById");
	private final static QName _SaveResponse_QNAME = new QName(
			"http://path.hibernate.server.dvx.ski.org/", "saveResponse");
	private final static QName _FindByPathPrefixResponse_QNAME = new QName(
			"http://path.hibernate.server.dvx.ski.org/",
			"findByPathPrefixResponse");
	private final static QName _FindAllResponse_QNAME = new QName(
			"http://path.hibernate.server.dvx.ski.org/", "findAllResponse");
	...
	private final static QName _Delete_QNAME = new QName(
			"http://path.hibernate.server.dvx.ski.org/", "delete");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of
	 * schema derived classes for package: org.ski.dvx.client.hibernate.path
	 * 
	 */
	...
	/**
	 * Create an instance of {@link FindByPathPrefixResponse }
	 * 
	 */
	public FindByPathPrefixResponse createFindByPathPrefixResponse() {
		return new FindByPathPrefixResponse();
	}
	...
	/**
	 * Create an instance of {@link FindByPathPrefix }
	 * 
	 */
	public FindByPathPrefix createFindByPathPrefix() {
		return new FindByPathPrefix();
	}
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://path.hibernate.server.dvx.ski.org/", name = "findAll")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://path.hibernate.server.dvx.ski.org/", name = "attachDirtyResponse")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://path.hibernate.server.dvx.ski.org/", name = "findByIdResponse")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://path.hibernate.server.dvx.ski.org/", name = "findByProperty")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://path.hibernate.server.dvx.ski.org/", name = "findByAuthorFk")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://path.hibernate.server.dvx.ski.org/", name = "attachClean")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://path.hibernate.server.dvx.ski.org/", name = "findByModified")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://path.hibernate.server.dvx.ski.org/", name = "findByPropertyResponse")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://path.hibernate.server.dvx.ski.org/", name = "findByModifiedResponse")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://path.hibernate.server.dvx.ski.org/", name = "attachCleanResponse")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://path.hibernate.server.dvx.ski.org/", name = "findByExample")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://path.hibernate.server.dvx.ski.org/", name = "deleteResponse")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://path.hibernate.server.dvx.ski.org/", name = "attachDirty")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://path.hibernate.server.dvx.ski.org/", name = "findByCreated")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://path.hibernate.server.dvx.ski.org/", name = "merge")
	...
	/**
	 * Create an instance of {@link JAXBElement }{@code <}
	 * {@link FindByPathPrefix }{@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "http://path.hibernate.server.dvx.ski.org/", name = "findByPathPrefix")
	public JAXBElement<FindByPathPrefix> createFindByPathPrefix(
			FindByPathPrefix value) {
		return new JAXBElement<FindByPathPrefix>(_FindByPathPrefix_QNAME,
				FindByPathPrefix.class, null, value);
	}
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://path.hibernate.server.dvx.ski.org/", name = "findByCreatedResponse")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://path.hibernate.server.dvx.ski.org/", name = "findByExampleResponse")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://path.hibernate.server.dvx.ski.org/", name = "save")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://path.hibernate.server.dvx.ski.org/", name = "mergeResponse")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://path.hibernate.server.dvx.ski.org/", name = "findById")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://path.hibernate.server.dvx.ski.org/", name = "saveResponse")
	...
	/**
	 * Create an instance of {@link JAXBElement }{@code <}
	 * {@link FindByPathPrefixResponse }{@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "http://path.hibernate.server.dvx.ski.org/", name = "findByPathPrefixResponse")
	public JAXBElement<FindByPathPrefixResponse> createFindByPathPrefixResponse(
			FindByPathPrefixResponse value) {
		return new JAXBElement<FindByPathPrefixResponse>(
				_FindByPathPrefixResponse_QNAME,
				FindByPathPrefixResponse.class, null, value);
	}
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://path.hibernate.server.dvx.ski.org/", name = "findAllResponse")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://path.hibernate.server.dvx.ski.org/", name = "findByAuthorFkResponse")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://path.hibernate.server.dvx.ski.org/", name = "delete")
