...
//			System.out.println(nextEvent.getEventID() + " : " + longTimeToString(nextEvent.getStartTime()) + " - " + nextEvent.getCaption());
	...
	{
		System.out.println("Loading Captions...");
	       try {
			...
			System.out.println("Captions Loading Completed...");
			...
			while (true)
			{
				...
				nowTime += (ONE_SECOND/30);
				startTime+=(ONE_SECOND/30);
//				long waitTime = System.currentTimeMillis()+(ONE_SECOND/30);
				...
				//	System.out.println(startTime + " > " + System.currentTimeMillis()+ " = " + "" + (startTime  - System.currentTimeMillis()));
				}
...
//				nowTime=nowTime + (ONE_SECOND/30);
	...
	public static void main(String[] args) {
		...
		System.out.println("Starting Caption Player...");
