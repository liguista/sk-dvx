...
public abstract class AbstractUser implements java.io.Serializable {
	...
	public AbstractUser(String userEmail, String userPassword,
			String userHandle, Timestamp userLastLogin, Boolean userActive,
			Integer userType, Timestamp created, Timestamp modified,
			Set userProfiles, Set transactionLogs, Set authors,
			Set userDetails, Set reviews, Set ratings) {
