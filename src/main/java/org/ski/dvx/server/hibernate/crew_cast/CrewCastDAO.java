 ...
 * CrewCast entities. Transaction control of the save(), update() and delete()
 * operations can directly support Spring container-managed transactions or they
 * can be augmented to handle user-managed Spring transactions. Each of these
 * methods provides additional information for how to configure it for the
 * desired type of transaction control.
 * 
 * @see org.ski.dvx.server.hibernate.crew_cast.CrewCast
 * @author MyEclipse Persistence Tools
 */

public class CrewCastDAO extends BaseHibernateDAO {
	private static final Logger log = LoggerFactory
			.getLogger(CrewCastDAO.class);
	// property constants
	...
	public static final String CREW_CAST_BIRTHDAY = "crewCastBirthday";
	...
	public static final String CREW_CAST_AUTHOR_FK = "crewCastAuthorFk";
	...
	public CrewCast findById(java.lang.Integer id) {
		...
		try {
			CrewCast instance = (CrewCast) getSession().get(
					"org.ski.dvx.server.hibernate.crew_cast.CrewCast", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(CrewCast instance) {
		...
		try {
			List results = getSession()
					.createCriteria(
							"org.ski.dvx.server.hibernate.crew_cast.CrewCast")
	...
	public List findByCrewCastBirthday(Object crewCastBirthday) {
		return findByProperty(CREW_CAST_BIRTHDAY, crewCastBirthday);
	}
	...
	public List findByCrewCastAuthorFk(Object crewCastAuthorFk) {
		return findByProperty(CREW_CAST_AUTHOR_FK, crewCastAuthorFk);
	}
	...
	public CrewCast merge(CrewCast detachedInstance) {
		...
		try {
			CrewCast result = (CrewCast) getSession().merge(detachedInstance);
