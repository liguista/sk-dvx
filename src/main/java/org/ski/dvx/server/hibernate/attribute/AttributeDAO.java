 ...
 * 
 * @see org.ski.dvx.server.hibernate.attribute.Attribute
	...
	public Attribute findById(java.lang.Integer id) {
		...
		try {
			Attribute instance = (Attribute) getSession().get(
					"org.ski.dvx.server.hibernate.attribute.Attribute", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Attribute instance) {
		...
		try {
			List results = getSession()
					.createCriteria(
							"org.ski.dvx.server.hibernate.attribute.Attribute")
