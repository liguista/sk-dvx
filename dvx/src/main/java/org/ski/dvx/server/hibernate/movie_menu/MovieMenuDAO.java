...
/**
	 ...
	 * @see org.ski.dvx.server.hibernate.movie_menu.MovieMenu
...
public class MovieMenuDAO extends BaseHibernateDAO  {
	...
	public static final String LANGUAGE_FK = "languageFk";
	...
	public static final String MENU_PATH_FK = "menuPathFk";
    ...
    public MovieMenu findById( java.lang.Integer id) {
        ...
        try {
            MovieMenu instance = (MovieMenu) getSession()
                    .get("org.ski.dvx.server.hibernate.movie_menu.MovieMenu", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(MovieMenu instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("org.ski.dvx.server.hibernate.movie_menu.MovieMenu")
	...
	public List findByLanguageFk(Object languageFk
		...
		return findByProperty(LANGUAGE_FK, languageFk
		);
	}
	...
	public List findByMenuPathFk(Object menuPathFk
		...
		return findByProperty(MENU_PATH_FK, menuPathFk
		);
	}
