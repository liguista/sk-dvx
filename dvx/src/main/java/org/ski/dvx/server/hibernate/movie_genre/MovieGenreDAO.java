 ...
 * 
 * @see org.ski.dvx.server.hibernate.movie_genre.MovieGenre
	...
	public MovieGenre findById(java.lang.Integer id) {
		...
		try {
			MovieGenre instance = (MovieGenre) getSession().get(
					"org.ski.dvx.server.hibernate.movie_genre.MovieGenre", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(MovieGenre instance) {
		...
		try {
			List results = getSession()
					.createCriteria(
							"org.ski.dvx.server.hibernate.movie_genre.MovieGenre")
