...
public class UserDetail extends AbstractUserDetail implements
	...
	public UserDetail(User user, State state, ZipCode zipCode, City city,
			...
			String userDetailCellPhoneNumber, Date userDetailSubscriptionStart,
			Date userDetailSubscriptionEndDate, String userDetailActive,
			Timestamp created, Timestamp modified,
			Integer userDetailYearOfBirth, String userDetailGender,
			String userDetailVisionAbility, Set userProfiles) {
		super(user, state, zipCode, city, country, userDetailFirstName,
				...
				userDetailActive, created, modified, userDetailYearOfBirth,
				userDetailGender, userDetailVisionAbility, userProfiles);
	}
