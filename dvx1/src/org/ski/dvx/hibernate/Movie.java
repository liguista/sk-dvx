...
public class Movie extends AbstractMovie implements java.io.Serializable {
	...
	public Movie(Country country, Status status, Rating rating,
			...
			Set ratings, Set movieTrailers, Set versions, Set movieMenus,
			Set movieCasts, Set descriptions) {
		super(country, status, rating, movieName, movieSbnNumber,
				movieAuthorFk, movieActive, movieReleased, movieRatingTemp,
				movieLanguageMainFk, movieRating, movieQuote, movieDescription,
				movieExtraFeatures, movieRuntime, movieBudget, movieRevenue,
				movieWebpage, moviePathFk, created, modified, movieChapters,
				transactionLogs, posters, reviews, ratings, movieTrailers,
				versions, movieMenus, movieCasts, descriptions);
	}
