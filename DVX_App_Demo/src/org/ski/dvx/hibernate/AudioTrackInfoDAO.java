...
/**
 	* A data access object (DAO) providing persistence and search support for AudioTrackInfo entities.
 			* Transaction control of the save(), update() and delete() operations 
		can directly support Spring container-managed transactions or they can be augmented	to handle user-managed Spring transactions. 
		Each of these methods provides additional information for how to configure it for the desired type of transaction control. 	
	 * @see org.ski.dvx.hibernate.AudioTrackInfo
  * @author MyEclipse Persistence Tools 
 */

public class AudioTrackInfoDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(AudioTrackInfoDAO.class);
		//property constants
    ...
    public AudioTrackInfo findById( java.lang.Integer id) {
        ...
        try {
            AudioTrackInfo instance = (AudioTrackInfo) getSession()
                    .get("org.ski.dvx.hibernate.AudioTrackInfo", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(AudioTrackInfo instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("org.ski.dvx.hibernate.AudioTrackInfo")
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding AudioTrackInfo instance with property: " + propertyName
            + ", value: " + value);
      try {
    ...
    public AudioTrackInfo merge(AudioTrackInfo detachedInstance) {
        ...
        try {
            AudioTrackInfo result = (AudioTrackInfo) getSession()
