...
/**
 	* A data access object (DAO) providing persistence and search support for Poster entities.
 			* Transaction control of the save(), update() and delete() operations 
		can directly support Spring container-managed transactions or they can be augmented	to handle user-managed Spring transactions. 
		Each of these methods provides additional information for how to configure it for the desired type of transaction control. 	
	 * @see org.ski.dvx.hibernate.Poster
...
public class PosterDAO extends BaseHibernateDAO  {
    ...
    public Poster findById( java.lang.Integer id) {
        ...
        try {
            Poster instance = (Poster) getSession()
                    .get("org.ski.dvx.hibernate.Poster", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(Poster instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("org.ski.dvx.hibernate.Poster")
    ...
    public Poster merge(Poster detachedInstance) {
        ...
        try {
            Poster result = (Poster) getSession()
