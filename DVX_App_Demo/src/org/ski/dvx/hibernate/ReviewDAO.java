...
/**
	 ...
	 * @see org.ski.dvx.hibernate.Review
...
public class ReviewDAO extends BaseHibernateDAO  {
    ...
    public Review findById( java.lang.Integer id) {
        ...
        try {
            Review instance = (Review) getSession()
                    .get("org.ski.dvx.hibernate.Review", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(Review instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("org.ski.dvx.hibernate.Review")
    ...
    public Review merge(Review detachedInstance) {
        ...
        try {
            Review result = (Review) getSession()
