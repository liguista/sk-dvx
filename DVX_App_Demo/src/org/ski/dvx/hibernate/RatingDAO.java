...
/**
 	* A data access object (DAO) providing persistence and search support for Rating entities.
 			* Transaction control of the save(), update() and delete() operations 
		can directly support Spring container-managed transactions or they can be augmented	to handle user-managed Spring transactions. 
		Each of these methods provides additional information for how to configure it for the desired type of transaction control. 	
	 * @see org.ski.dvx.hibernate.Rating
...
public class RatingDAO extends BaseHibernateDAO  {
    ...
    public Rating findById( java.lang.Integer id) {
        ...
        try {
            Rating instance = (Rating) getSession()
                    .get("org.ski.dvx.hibernate.Rating", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(Rating instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("org.ski.dvx.hibernate.Rating")
    ...
    public Rating merge(Rating detachedInstance) {
        ...
        try {
            Rating result = (Rating) getSession()
