...
/**
 	* A data access object (DAO) providing persistence and search support for Path entities.
...
public class PathDAO extends BaseHibernateDAO  {
    ...
    public Path findById( java.lang.Integer id) {
        ...
        try {
            Path instance = (Path) getSession()
                    .get("org.ski.dvx.hibernate.Path", id);
            return instance;
        } catch (RuntimeException re) {
