...
/**
	 ...
	 * @see org.ski.dvx.hibernate.Status
...
public class StatusDAO extends BaseHibernateDAO  {
    ...
    public Status findById( java.lang.Integer id) {
        ...
        try {
            Status instance = (Status) getSession()
                    .get("org.ski.dvx.hibernate.Status", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(Status instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("org.ski.dvx.hibernate.Status")
    ...
    public Status merge(Status detachedInstance) {
        ...
        try {
            Status result = (Status) getSession()
