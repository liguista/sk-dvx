...
/**
 	* A data access object (DAO) providing persistence and search support for TransactionLog entities.
 			* Transaction control of the save(), update() and delete() operations 
		can directly support Spring container-managed transactions or they can be augmented	to handle user-managed Spring transactions. 
		Each of these methods provides additional information for how to configure it for the desired type of transaction control. 	
	 * @see org.ski.dvx.hibernate.TransactionLog
  * @author MyEclipse Persistence Tools 
 */

public class TransactionLogDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(TransactionLogDAO.class);
		//property constants
    ...
    public TransactionLog findById( java.lang.Integer id) {
        ...
        try {
            TransactionLog instance = (TransactionLog) getSession()
                    .get("org.ski.dvx.hibernate.TransactionLog", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(TransactionLog instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("org.ski.dvx.hibernate.TransactionLog")
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding TransactionLog instance with property: " + propertyName
            + ", value: " + value);
      try {
    ...
    public TransactionLog merge(TransactionLog detachedInstance) {
        ...
        try {
            TransactionLog result = (TransactionLog) getSession()
