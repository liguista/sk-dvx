...
/**
 * AbstractMovieGenre entity provides the base persistence definition of the MovieGenre entity. @author MyEclipse Persistence Tools
 */
...
public abstract class AbstractMovieGenre  implements java.io.Serializable {
    ...
    /** full constructor */
    public AbstractMovieGenre(String movieGenreDescription, String movieGenreDescriptionLong, Timestamp created, Timestamp modified) {
