...
/**
 	* A data access object (DAO) providing persistence and search support for UserProfile entities.
 			* Transaction control of the save(), update() and delete() operations 
		can directly support Spring container-managed transactions or they can be augmented	to handle user-managed Spring transactions. 
		Each of these methods provides additional information for how to configure it for the desired type of transaction control. 	
	 * @see org.ski.dvx.hibernate.UserProfile
...
public class UserProfileDAO extends BaseHibernateDAO  {
    ...
    public UserProfile findById( java.lang.Integer id) {
        ...
        try {
            UserProfile instance = (UserProfile) getSession()
                    .get("org.ski.dvx.hibernate.UserProfile", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(UserProfile instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("org.ski.dvx.hibernate.UserProfile")
	...
	public List findByUserProfileVisionImpared(Object userProfileVisionImpared
		...
		return findByProperty(USER_PROFILE_VISION_IMPARED, userProfileVisionImpared
		);
	}
	
	public List findByUserProfileMotionImpared(Object userProfileMotionImpared
	) {
		return findByProperty(USER_PROFILE_MOTION_IMPARED, userProfileMotionImpared
		);
	}
    ...
    public UserProfile merge(UserProfile detachedInstance) {
        ...
        try {
            UserProfile result = (UserProfile) getSession()
