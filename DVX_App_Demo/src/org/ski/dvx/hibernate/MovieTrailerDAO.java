...
/**
 	* A data access object (DAO) providing persistence and search support for MovieTrailer entities.
 			* Transaction control of the save(), update() and delete() operations 
		can directly support Spring container-managed transactions or they can be augmented	to handle user-managed Spring transactions. 
		Each of these methods provides additional information for how to configure it for the desired type of transaction control. 	
	 * @see org.ski.dvx.hibernate.MovieTrailer
  * @author MyEclipse Persistence Tools 
 */

public class MovieTrailerDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(MovieTrailerDAO.class);
		//property constants
    ...
    public MovieTrailer findById( java.lang.Integer id) {
        ...
        try {
            MovieTrailer instance = (MovieTrailer) getSession()
                    .get("org.ski.dvx.hibernate.MovieTrailer", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(MovieTrailer instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("org.ski.dvx.hibernate.MovieTrailer")
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding MovieTrailer instance with property: " + propertyName
            + ", value: " + value);
      try {
    ...
    public MovieTrailer merge(MovieTrailer detachedInstance) {
        ...
        try {
            MovieTrailer result = (MovieTrailer) getSession()
